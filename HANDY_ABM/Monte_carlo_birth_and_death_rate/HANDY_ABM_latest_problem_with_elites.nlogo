...
;;-------------------------------- Some of the globals are soft-coded because we don't want the users of model to mess up with them --------------------------------------------------
    set nominal-birth-rate  3            ;; nominal birth rate in HANDY set to 3%
...
to handy-birth-commoners
    if count commoners > 0 and random 100 < nominal-birth-rate
    [hatch 1]
end
...
to handy-birth-elites
    if count elites > 0 and random 100 < nominal-birth-rate
    [hatch 1]
end
...
to famine-rules-commoners
  ...
  ask elites[
  ifelse (famine-check < ( 1 / inequality-factor) and (inequality-factor > 1 or inequality-factor = 1))
      [handy-death-commoners
      wiggle
      ifelse movement
      [move]
...
"Elites" 1.0 0 -4079321 true "" "plot count elites * 100"
